...
// TODO: Test this
open class MutableStringMapTable @JvmOverloads constructor(defaultEntries: MutableList<ConfigSetting<StringType, StringType>>, tableEntries: MutableList<ConfigSetting<StringType, StringType>> = defaultEntries, name: String, comment: String? = null) : StringMapTable(defaultEntries, tableEntries, name, comment), MutableMapConfigTable<StringType> {
    ...
    override fun toImmutable(): MapConfigTable<StringType> {
