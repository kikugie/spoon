...
open class NumberSetting<T : Number> @JvmOverloads constructor(
    ...
    class Builder<T : Number> @JvmOverloads constructor(id: SettingLocation, comment: String? = null, defaultValue: T) : ConfigSetting.Builder<NumberSetting<T>, T, NumberType<T>>(id, comment, defaultValue) {
